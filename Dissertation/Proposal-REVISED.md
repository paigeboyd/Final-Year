...
CALL emerged in the 1960s. Defined by Levy (1997) as "the search for and study of applications of the computer in language teaching and learning", CALL enables users to improve their language skills using online resources and assessments.  <!-- find this guys full name -->
...
By the nineties, CALL was integrative. The introduction of the CD-ROM enabled users to make use of a variety of media. It took a humanistic approach, with users aiming for fluency. This was when CALL began considering the learner.
